...
// cmd:20010
type JoinReq struct {
	UseLast          *bool    `protobuf:"varint,1,req,name=use_last,json=useLast" json:"use_last,omitempty"`
	SpaceId          []byte   `protobuf:"bytes,2,req,name=space_id,json=spaceId" json:"space_id,omitempty"`
	...
	ExData           []byte   `protobuf:"bytes,6,opt,name=ex_data,json=exData" json:"ex_data,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func init() { proto.RegisterFile("pb/payload.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 524 bytes of a gzipped FileDescriptorProto
	,
}
